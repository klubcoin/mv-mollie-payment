...
public class CheckoutPage extends Script {
    ...
    public void execute(Map<String, Object> parameters) throws BusinessException {
        ...
        result = "<!DOCTYPE html>\r\n"
            ...
            + "box-shadow: 0 6px 20px 0 rgba(0, 0, 0, 0.19);color: #fff;border-radius: 1em;"
            + "padding: 1em;position: absolute;top: 50%;left: 50%;margin-right: -50%;transform: translate(-50%, -50%);"
            + "text-align: center;min-width:351px;}\r\n"
